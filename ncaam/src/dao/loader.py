...
from ncaam.src.constants import DATA_PATH, DATA_FILES, PLAY_BY_PLAY, STAGE, \
    CITIES_TABLE, CONFERENCES_TABLE, CONFERENCE_TOURNEY_GAMES_TABLE, GAME_CITIES_TABLE, MASSEY_ORDINALS_TABLE, \
    TOURNEY_COMPACT_RESULTS_TABLE, TOURNEY_DETAILED_RESULTS_TABLE, TOURNEY_SEED_ROUND_SLOTS_TABLE, \
    TOURNEY_SEEDS_TABLE, TOURNEY_SLOTS_TABLE, REGULAR_SEASON_COMPACT_RESULTS_TABLE, \
    REGULAR_SEASON_DETAILED_RESULTS_TABLE, SEASONS_TABLE, SECONDARY_TOURNEY_COMPACT_RESULTS_TABLE, \
    SECONDARY_TOURNEY_TEAMS_TABLE, TEAM_COACHES_TABLE, TEAM_CONFERENCES_TABLE, TEAMS_TABLE, \
    TEAM_SPELLING_TABLE, EVENTS_TABLE, PLAYERS_TABLE

DESIRED_TABLES: list = [CITIES_TABLE, CONFERENCES_TABLE, CONFERENCE_TOURNEY_GAMES_TABLE, GAME_CITIES_TABLE,
                        MASSEY_ORDINALS_TABLE, TOURNEY_COMPACT_RESULTS_TABLE, TOURNEY_DETAILED_RESULTS_TABLE,
                        TOURNEY_SEED_ROUND_SLOTS_TABLE, TOURNEY_SEEDS_TABLE, TOURNEY_SLOTS_TABLE,
                        REGULAR_SEASON_COMPACT_RESULTS_TABLE, REGULAR_SEASON_DETAILED_RESULTS_TABLE,
                        SEASONS_TABLE, SECONDARY_TOURNEY_COMPACT_RESULTS_TABLE, SECONDARY_TOURNEY_TEAMS_TABLE,
                        TEAM_COACHES_TABLE, TEAM_CONFERENCES_TABLE, TEAMS_TABLE, TEAM_SPELLING_TABLE,
